; Work around Neovim 0.12.x Treesitter crashes on markdown fenced code blocks.
; This mirrors the upstream markdown highlights query but omits conceal_lines.
